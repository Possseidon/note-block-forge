...
use eframe::{get_value, set_value, CreationContext, Frame, Storage};
use egui::{include_image, CentralPanel, Context, ImageSource, TopBottomPanel};
use note_block_forge_lib::{
    instruments::{BuiltinInstrument, MelodicInstrument, PercussionInstrument},
    midi::{config::MidiConfig, connection::MidiConnections},
...
use crate::{
    about::about_dialog,
    menu::MAIN_MENU,
    midi_devices::{midi_devices_dialog, MidiDeviceWindows},
...
impl App {
    pub const NAME: &'static str = "NoteBlockForge";
